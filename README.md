...
In addition, unit test, nosql support, api documents and some auxiliary scripts, etc.The Gab PHP framework directory as follows:
...
As above, we implemented a gab micro monolith structure.But how  these module to communicate with each other? As follows:
